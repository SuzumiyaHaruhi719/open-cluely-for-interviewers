...
The media clock is the only replay clock. Normal playback, 60× fast-forward, captions, role labels, questions, context, progress, and completion all derive from it. Seeking backwards reconstructs state and dismisses future summary/question state.
