...
2. Cover ALL substantive claims: metrics, named tools, owners-of-action ("I" vs "we"), timelines, outcomes, opinions. PRIORITIZE the spans a depth follow-up would anchor on: a DECISION/redesign/approach the candidate chose (claim_type "action" or "opinion"), an OUTCOME asserted without mechanism (claim_type "outcome"), and any "we"/"the team" OWNERSHIP span (claim_type "team-attribution") — these are where the candidate's judgment is hidden and most worth probing. Aim for 3-8 claims for a real answer; 0-2 for a non-answer. Do NOT split one claim into many to inflate count.
