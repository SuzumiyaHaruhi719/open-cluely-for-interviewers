...
3. **Remove the legacy assistant subsystem end-to-end.** Recommended. Delete the two menu actions, results panel/hook, client API wrappers, server router, route tests, and panel-only CSS. Keep the GLP more-menu with “清空会话.”

## Approved behavior

- The topbar keeps its current GLP layout and styling.
- The more-menu contains only “清空会话.”
...
- Component test: the topbar more-menu exposes “清空会话” and does not expose “会议纪要” or “洞察.”
...
- Browser acceptance: open the more-menu in the rebuilt app and confirm only “清空会话” remains while “总结面试” and “生成追问” are still visible.
