// AudioWorklet processor adapted VERBATIM from the desktop app's
// src/windows/assistant/pcm-capture-worklet.js. It buffers the incoming float32
// audio (whatever the AudioContext's native rate is) into fixed 2048-sample
// chunks and posts them to the main thread. The main thread (audioCapture.ts)
// does the downsample-to-16k + float->int16 + framing using the shared pure
// helpers in src/lib/pcm.ts — keeping THIS file's DSP identical to desktop.
