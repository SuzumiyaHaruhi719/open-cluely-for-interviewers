    ...
    <article className="chat-message lane-ai is-question-card" aria-label={copy.ariaFollowUp}>
      ...
      {others.length > 0 ? (
        <details className="question-card__ranked">
          <summary className="question-card__ranked-summary">{copy.rankedSummary(others.length)}</summary>
      ...
      {output.alternative_question ? (
        <div className="question-card__alt">
          <span className="message-label">{copy.alternative}</span>
      ...
      {output.rationale_for_interviewer ? (
        <div className="question-card__rationale">
          <span className="message-label">{copy.why}</span>
      ...
      {output.expected_evidence_yield ? (
        <div className="question-card__yield">
          <span className="message-label">{copy.expected}</span>
